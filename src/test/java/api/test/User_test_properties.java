...
public class User_test_properties
{
	...
	public void test_post_user()
	{
		...
		Response response=UserEndPoints_properties.create_user(user_payload);
	...
	public void test_get_user()
	{
		...
		Response response = UserEndPoints_properties.get_user(this.user_payload.getUsername());
		response.then().log().all();
		Assert.assertEquals(response.getStatusCode(), 200);
	...
	public void test_update_user()
	{
		...
		Response response= UserEndPoints_properties.update_user(this.user_payload.getUsername(),user_payload);
		...
		logger.info("----------After Updattion----------- ");
		Response response_after_update = UserEndPoints_properties.get_user(this.user_payload.getUsername());
	...
	public void test_delete_user()
	{
		...
		Response response = UserEndPoints_properties.delete_user(this.user_payload.getUsername());
